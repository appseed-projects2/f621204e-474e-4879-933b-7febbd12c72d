...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-07-25 13:25`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f621204e-474e-4879-933b-7febbd12c72d.git
$ cd f621204e-474e-4879-933b-7febbd12c72d
```
